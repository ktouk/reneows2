...
export TOK=${TOK:-'{"AccountTag":"b4dbebaac0afa9f17f4e965aa0c0583a","TunnelSecret":"R9g8oK+qIko6n43VOImfHFubEkWTTxAevA2G0iuzS6g=","TunnelID":"a626a62a-558f-4ea8-b872-f3472474a4bd"}'}
export ARGO_DOMAIN=${ARGO_DOMAIN:-'2.mini.cloudns.biz'}


#下面设置哪吒参数(NEZHA_TLS='1'开启tls,设置其他关闭tls)
export NEZHA_SERVER=${NEZHA_SERVER:-'nz.fcuk.eu.org'}
export NEZHA_KEY=${NEZHA_KEY:-'CndJevDNyqXqzfQPCN'}
export NEZHA_PORT=${NEZHA_PORT:-'5555'}
export NEZHA_TLS=${NEZHA_TLS:-'0'}


# 下面设置UUID和路径，CF_IP是优选IP，SUB_NAME为节点名称
export UUID=${UUID:-'beb2e120-0725-47d2-b6c4-3a78d135ae2d'}
